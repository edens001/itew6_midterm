<template>
  <div class="app-wrapper">
    ...
    <div class="main-content">
      <TopNav :pageTitle="'Curricular Events'" />
        ...
        <div class="content-card">
          ...
          <div class="content-header">
            <div class="d-flex align-items-center">
              ...
              <div>
                <h2 class="mb-1">Curricular Events</h2>
                <p class="text-muted mb-0">Manage academic events and activities</p>
              </div>
            </div>
          ...
          <div v-else class="events-grid">
            <div v-if="events.length === 0" class="empty-state">
              ...
              <h5>No Curricular Events Found</h5>
              ...
              <div v-for="event in events" :key="event.id" class="col-md-6 col-lg-4">
                <div class="event-card" :class="'event-' + event.status.toLowerCase()">
                  <div class="event-header">
                    <span class="event-type">Curricular</span>
  ...
  setup() {
    ...
    const fetchEvents = async () => {
      ...
      try {
        ...
        const response = await axios.get(`${API_URL}/admin/events/curricular.php`, {
    ...
    const saveEvent = async () => {
      ...
      try {
        ...
        const url = eventForm.value.id 
          ...
          : `${API_URL}/admin/events/curricular.php`
